...
export default class UserRepository {
  ...
  static async createFromAuth(
    ...
    /**
     * Add 8 tokens as default favorites
     * Algo HDL Yieldly Planets Opulous Choice Acorn Akita
     */
    const defaultTokens = [0, 137594422, 226701642, 27165954, 287867876, 297995609, 226265212, 523683256];

    for (let i = 0; i < defaultTokens.length; i++) {
      const assetId = defaultTokens[i];
  ...
  static async createDefaultFavorites(user, options: IRepositoryOptions) {
    const transaction = SequelizeRepository.getTransaction(
      options,
    );
    const defaultTokens = [0, 137594422, 226701642, 27165954, 287867876, 297995609, 226265212, 523683256];
